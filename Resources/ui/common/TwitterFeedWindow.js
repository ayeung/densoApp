...
function TwitterFeedWindow(name) {
	...
	xhr.onload = function() {
		try {
			...
			for (var c=0;c<tweets.length;c++){
				...
				var coordinates = tweets[c].coordinates;
				...
				row.addEventListener('click', (function() {
					...
					return function(){
						...
						if (location) {
							...
							var addressMessage = Ti.UI.createLabel({
								textAlign: Ti.UI.TEXT_ALIGNMENT_CENTER,
								color: 'white',
								text: "Please enter the address from the tweet: \n\n'" + tmp + "'"
							});
							...
							addressWindow.add(addressMessage);
							addressWindow.add(addressField);
							addressWindow.add(buttonView); 
							addressWindow.open();
...
module.exports = TwitterFeedWindow;
